...
export default function WorkerPanel({ records = [], workerName, trailersCierre = [] }) {
  ...
  // ── Métricas del día ──────────────────────────────────────────────────────
  const resumenHoy  = useMemo(() => calcResumenWorker(recordsDeHoy(records), workerName), [records, workerName])
  const rankingHoy  = useMemo(() => calcRankingDia(records, trailersCierre), [records, trailersCierre])
